...
__all__ = [
    'DISPID_SPRuleParent', 'SpeechAllElements', 'SPVPRIORITY',
    'SREHypothesis', 'DISPID_SpeechGrammarRuleStateTransition',
    'ISpLexicon', 'SDTAlternates', 'SP_VISEME_5', 'SPSNoun',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPFM_NUM_MODES',
    'DISPID_SPPChildren', 'SpSharedRecognizer',
    'DISPID_SRCEPropertyNumberChange', 'tagSPTEXTSELECTIONINFO',
    'ISpeechPhraseElements', 'SECFIgnoreCase',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SRCEHypothesis', 'SVP_0',
    'SRTSMLTimeout', 'DISPID_SRAudioInputStream', 'SVSFVoiceMask',
    'SVSFParseSsml', 'ISpStreamFormatConverter',
    'SpeechCategoryAudioOut', 'SSFMOpenForRead', 'SECFIgnoreKanaType',
    'DISPID_SPPsItem', 'SpeechWordType', 'DISPID_SPPName',
    'DISPID_SpeechVoice', 'SASClosed', 'ISpPhraseAlt',
    'DISPID_SpeechPhraseProperties', 'SPEI_RESERVED2',
    'DISPID_SLPType', 'SpeechVoiceSpeakFlags', 'SRTReSent',
    'DISPID_SOTGetAttribute', 'DISPID_SVSLastStreamNumberQueued',
    'SAFT48kHz16BitStereo', 'SpeechRunState',
    'IInternetSecurityManager', 'SBONone',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRRTLength',
    'ISpSerializeState', 'DISPID_SPRsItem', 'ISpeechObjectToken',
    'SDA_Two_Trailing_Spaces', 'SPFILEMODE', 'SPSUnknown',
    'SGDSActiveUserDelimited', 'ISpeechVoiceStatus',
    'SREPropertyStringChange', 'SPWORDLIST', 'SGSEnabled', 'LONG_PTR',
    'eLEXTYPE_USER', 'SVSFIsFilename', 'SAFTCCITT_ALaw_22kHzMono',
    'SPRS_INACTIVE', 'DISPID_SpeechObjectToken', 'SECHighConfidence',
    'DISPID_SLGenerationId', 'ISpXMLRecoResult',
    'DISPID_SGRsFindRule', 'DISPID_SGRAddState', 'SGDisplay',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpEventSource', 'SVP_21',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRRGetXMLErrorInfo',
    'SPAUDIOSTATE', 'SRCS_Disabled', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SRRDiscardResultInfo', 'SP_VISEME_2',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SVGetProfiles',
    'ISpeechWaveFormatEx', 'SpAudioFormat', 'SPEI_PHRASE_START',
    'DISPID_SPEPronunciation', 'SITooLoud', 'DISPID_SOTsCount',
    'DISPID_SGRInitialState', 'SVEVoiceChange',
    'DISPID_SRRSpeakAudio', 'SASPause', 'SpWaveFormatEx',
    'SpMemoryStream', 'DISPID_SABIEventBias', 'eLEXTYPE_PRIVATE18',
    'SpeechVoiceEvents', 'DISPID_SMSAMMHandle', 'SVSFIsNotXML',
    'SPEI_SOUND_END', 'DISPID_SpeechPhraseRule',
    'DISPID_SpeechPhraseProperty', 'SPWT_PRONUNCIATION',
    'DISPID_SASState', 'DISPID_SVEEnginePrivate',
    'SAFT12kHz8BitStereo', 'SGDSActive',
    'DISPID_SPIEnginePrivateData', 'DISPID_SOTCGetDataKey',
    'DISPID_SPILanguageId', 'eLEXTYPE_RESERVED4',
    'DISPID_SDKDeleteValue', 'Speech_StreamPos_RealTime',
    'eLEXTYPE_RESERVED9', 'DISPID_SPARecoResult', 'SVF_None',
    'SAFT22kHz16BitMono', 'SpeechCategoryAudioIn', 'SPFM_CREATE',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SVEWord', 'SRSActive',
    'STCRemoteServer', 'SAFT12kHz16BitMono', 'DISPID_SPPs_NewEnum',
    'SPEI_PROPERTY_STRING_CHANGE', 'SpMMAudioOut',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SRCCreateGrammar',
    'SPCT_DICTATION', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SGRAttributes', 'ISpeechPhraseAlternates', 'SP_VISEME_11',
    'SpeechDisplayAttributes', 'SPRULESTATE',
    'DISPID_SVESentenceBoundary', 'SPAR_Unknown', 'SPEVENTENUM',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRCResume',
    'SVEWordBoundary', 'SPRECOSTATE', 'ISpeechBaseStream',
    'SAFT12kHz16BitStereo', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SVDisplayUI', 'SSSPTRelativeToCurrentPosition',
    'SPBO_PAUSE', 'DISPID_SGRSTType', 'SpeechEngineConfidence',
    ...
    'eLEXTYPE_PRIVATE13', 'DISPID_SGRSRule', 'DISPID_SMSADeviceId',
    'DISPID_SLWWord', 'ISpEventSink', 'SPSVerb', 'SDTAll',
    'DISPID_SFSOpen', 'SDTReplacement',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SPERequiredConfidence',
    'SVP_10', 'DISPID_SPEAudioSizeBytes', 'DISPID_SPRulesItem',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SVEventInterests',
    'SpeechTokenKeyFiles', 'SpResourceManager', 'SPPS_Unknown',
    'SPBO_AHEAD', 'SpeechCategoryRecoProfiles', 'SPGS_ENABLED',
    'SPLEXICONTYPE', 'SECFDefault', 'ISpRecognizer3',
    'DISPID_SWFEBitsPerSample', 'DISPID_SRCCreateResultFromMemory',
    'SAFTCCITT_ALaw_8kHzStereo', 'SGPronounciation',
    'DISPID_SPIReplacements', 'SpeechTokenKeyAttributes',
    'SAFTExtendedAudioFormat', 'ISpeechLexiconWord', 'SREStateChange',
    'DISPID_SASetState', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPRules_NewEnum', 'SFTSREngine', 'ISpRecoContext2',
    'DISPID_SPAStartElementInResult', 'SPEI_RECOGNITION',
    'SPCT_SLEEP', 'SRCS_Enabled', 'DISPID_SPPsCount',
    ...
    'SSFMCreateForWrite', 'SpeechTokenContext', 'ISpeechRecognizer',
    'SVEEndInputStream', 'DISPID_SRGIsPronounceable',
    'SPEI_RESERVED1', 'SAFT8kHz16BitMono', 'DISPID_SLPs_NewEnum',
    'DISPID_SLWType', 'SpeechAddRemoveWord',
    'SpeechEmulationCompareFlags', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SRGCmdSetRuleIdState', 'SREAllEvents', 'DISPID_SPACommit',
    'DISPID_SLPPartOfSpeech', 'DISPID_SpeechAudio', 'SPWT_LEXICAL',
    'DISPID_SASCurrentSeekPosition', 'SDKLCurrentUser',
    'DISPID_SRGCmdSetRuleState', 'SpObjectToken', 'SDKLLocalMachine',
    'STCLocalServer', 'DISPID_SLWLangId', 'SAFT16kHz8BitStereo',
    'DISPID_SPRuleEngineConfidence', 'SpeechRecognitionType',
    'SAFT48kHz16BitMono', 'DISPID_SRCAudioInInterferenceStatus',
    'SPXRO_SML', 'SPAS_RUN', '_SPAUDIOSTATE',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SOTSetId',
    'SAFT24kHz8BitStereo', 'DISPID_SpeechFileStream',
    'DISPID_SWFEChannels', 'DISPID_SRRecognizer',
    'DISPID_SGRSTransitions', 'DISPID_SpeechRecognizer',
    'SpeechBookmarkOptions', 'SpeechDataKeyLocation',
    'DISPID_SPISaveToMemory', 'SVP_20', 'SVF_Stressed',
    'SpeechRegistryUserRoot', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SVStatus', 'SINone', 'SPEI_TTS_PRIVATE',
    ...
    'ISpeechLexicon', 'DISPID_SPRulesCount', 'ISpeechPhraseRule',
    'SAFTGSM610_44kHzMono', 'DISPID_SRSetPropertyNumber',
    'SPPHRASEREPLACEMENT', 'DISPID_SLAddPronunciation',
    'DISPID_SRRPhraseInfo', 'STCAll', 'DISPID_SRRAudioFormat',
    'DISPID_SOTGetStorageFileName', 'eLEXTYPE_PRIVATE3',
    'SpeechVoicePriority', 'DISPID_SOTDataKey', 'SREPhraseStart',
    'SGDSInactive', 'ISpeechPhraseAlternate', 'eLEXTYPE_PRIVATE1',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SITooSlow',
    'DISPID_SPRText', 'SAFT16kHz16BitStereo', 'SpMMAudioEnum',
    'DISPID_SPIRule', 'SECNormalConfidence', 'SAFTADPCM_8kHzMono',
    'ISpNotifyTranslator', 'DISPID_SRCEBookmark',
    'SAFTADPCM_8kHzStereo', 'DISPID_SVSLastResult',
    'SPRECOGNIZERSTATUS', 'SP_VISEME_14', 'SDKLDefaultLocation',
    'DISPID_SAFType', 'SPINTERFERENCE_TOOFAST', 'DISPID_SPAsCount',
    'DISPID_SOTCId', 'SRTEmulated', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRState', 'DISPID_SPPId', 'SRERecoOtherContext',
    'DISPID_SVSVisemeId', 'DISPID_SRIsUISupported',
    'DISPID_SRRTTickCount', 'ISpeechPhraseProperty',
    'DISPID_SPEDisplayAttributes', 'SLODynamic',
    'DISPID_SpeechRecoResult', 'SREBookmark', 'SpeechAudioProperties',
    'DISPID_SVEStreamStart', 'SRADynamic',
    'DISPID_SGRSAddWordTransition', 'SPCT_COMMAND', 'SVP_9',
    'SAFTGSM610_8kHzMono', 'DISPID_SpeechMemoryStream',
    'SpFileStream', 'SVSFParseSapi', 'SPEI_END_SR_STREAM',
    'ISpeechResourceLoader', 'SPADAPTATIONRELEVANCE',
    'DISPID_SLGetGenerationChange', 'SpeechPropertyAdaptationOn',
    'DISPID_SRGDictationUnload', 'Library',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SRGDictationSetState',
    'DISPID_SWFEFormatTag', 'DISPID_SGRsCommitAndSave',
    'DISPID_SPEDisplayText', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SPEsCount', 'SPAR_Low',
    'ISpeechAudioFormat', 'SPSNotOverriden',
    'DISPID_SDKGetBinaryValue', 'DISPID_SRCEAudioLevel',
    'SPDKL_LocalMachine', 'SAFTADPCM_44kHzStereo',
    'DISPID_SOTIsUISupported', 'SVEBookmark', 'SRTExtendableParse',
    'SINoSignal', 'ISpeechLexiconPronunciations',
    ...
    'SAFTADPCM_22kHzMono', 'DISPID_SpeechPhraseInfo',
    'SAFT48kHz8BitMono', 'ISequentialStream', '__MIDL_IWinTypes_0009',
    'SDKLCurrentConfig', 'SPAUDIOSTATUS',
    'DISPID_SpeechPhoneConverter', 'SVP_15',
    'DISPID_SOTGetDescription', 'Speech_Default_Weight',
    'DISPID_SRRAudio', 'DISPID_SVVolume', 'DISPID_SVAudioOutput',
    'IInternetSecurityMgrSite', 'DISPID_SRGReset', 'SpeechRuleState',
    'SPFM_OPEN_READWRITE', 'SpeechCategoryVoices',
    'DISPID_SGRs_NewEnum', 'DISPID_SpeechGrammarRuleState',
    'SP_VISEME_9', 'SPCONTEXTSTATE', 'SLTUser', 'SAFTADPCM_44kHzMono',
    'SAFT24kHz16BitStereo', 'DISPID_SRSAudioStatus', 'ISpVoice',
    '_ISpeechVoiceEvents', 'SPSMF_UPS', 'SGRSTTWord',
    'SAFT32kHz8BitMono',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SRSEDone',
    'SPPS_Modifier', 'DISPID_SLWPronunciations', 'STSF_CommonAppData',
    'DISPID_SRSSupportedLanguages', 'SPLOADOPTIONS',
    'SRSInactiveWithPurge', 'SRAInterpreter', 'DISPID_SOTDisplayUI',
    'eLEXTYPE_PRIVATE14', 'SP_VISEME_16', 'ISpRecoContext',
    'DISPID_SRCEInterference', 'SPSHT_Unknown',
    'SpeechGrammarWordType', 'DISPID_SGRSTWeight',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SpeechVoiceStatus',
    'DISPID_SBSWrite', 'DISPID_SAStatus', 'SGRSTTTextBuffer',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPIElements',
    'ISpObjectWithToken', 'DISPID_SVSInputSentenceLength',
    'SAFT44kHz16BitMono', 'ISpPhoneticAlphabetConverter', 'SpStream',
    'SAFT8kHz8BitMono', 'ISpProperties', 'DISPID_SLPPhoneIds',
    'SPEI_SOUND_START', 'SVEAllEvents', 'SPAS_STOP', 'SP_VISEME_6',
    'SPWORDPRONUNCIATIONLIST', 'ISpObjectToken', 'SVP_11',
    'DISPID_SpeechAudioBufferInfo', 'SpeechRegistryLocalMachineRoot',
    'ISpeechPhoneConverter', 'DISPID_SAFSetWaveFormatEx',
    'SpPhraseInfoBuilder', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SGRId', 'SGLexical', 'SP_VISEME_1',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SLWs_NewEnum',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SLWsCount', 'DISPID_SRCVoice',
    'DISPID_SABIBufferSize', 'SpeechGrammarTagUnlimitedDictation',
    'SPWT_DISPLAY', 'SP_VISEME_19', 'DISPID_SDKDeleteKey',
    'DISPID_SDKOpenKey', 'SPAUDIOBUFFERINFO',
    'SpeechRecoProfileProperties', 'SPVISEMES', 'SPGS_EXCLUSIVE',
    'ISpStream', 'SVPOver', 'eLEXTYPE_RESERVED8',
    'DISPID_SVWaitUntilDone', 'ISpDataKey', 'SPINTERFERENCE_TOOSLOW',
    'SVSFUnusedFlags', 'SGDSActiveWithAutoPause',
    'DISPID_SPEEngineConfidence', 'DISPID_SGRAddResource',
    'SpeechVisemeType', 'SRAORetainAudio',
    'DISPID_SLRemovePronunciationByPhoneIds', 'UINT_PTR',
    'SDA_Consume_Leading_Spaces', 'DISPID_SLPSymbolic', 'SP_VISEME_7',
    'DISPID_SAFGuid', 'SpeechFormatType', 'Speech_StreamPos_Asap',
    'STCInprocHandler', 'DISPID_SBSFormat',
    'DISPID_SGRSTPropertyValue', 'SECLowConfidence',
    'DISPID_SOTMatchesAttributes', 'DISPID_SDKSetBinaryValue',
    'DISPID_SVPriority', 'DISPID_SGRClear', 'SREInterference',
    'SPSHT_EMAIL', 'SVSFPersistXML', 'SAFT44kHz16BitStereo',
    'ISpPhrase', 'DISPID_SWFEBlockAlign', 'ISpObjectTokenCategory',
    'SPEI_TTS_AUDIO_LEVEL', 'SAFTText', 'SPINTERFERENCE',
    'SDA_One_Trailing_Space', 'SPRST_NUM_STATES', 'SPSHORTCUTTYPE',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SPIGetText',
    'DISPID_SPPParent', 'SpUnCompressedLexicon',
    'SPEI_FALSE_RECOGNITION', 'ISpStreamFormat', 'DISPID_SOTsItem',
    'SAFT32kHz8BitStereo', 'SP_VISEME_15', 'SVSFNLPMask',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SAFT11kHz8BitMono',
    'DISPID_SPRuleChildren', 'DISPID_SpeechRecognizerStatus',
    'eLEXTYPE_PRIVATE5', 'SVP_13', 'SSFMOpenReadWrite',
    'SAFT24kHz16BitMono', 'SDTAudio', 'DISPID_SRStatus',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPRuleId',
    'SAFT12kHz8BitMono', 'eLEXTYPE_PRIVATE20',
    'DISPID_SpeechPhraseElements', 'SPLO_STATIC', 'DISPID_SLPsCount',
    'SPPROPERTYINFO', 'SpeechCategoryRecognizers',
    'eLEXTYPE_PRIVATE10', 'SPDKL_CurrentUser',
    'DISPID_SRCRetainedAudio', 'SDTProperty', 'SVSFDefault',
    'DISPID_SpeechDataKey', 'SRAImport', 'SPSEMANTICERRORINFO',
    'SLTApp', 'SpeechTokenValueCLSID', 'eLEXTYPE_PRIVATE11',
    'SPFM_CREATE_ALWAYS', 'DISPID_SGRsCommit', 'SpeechInterference',
    'SpCompressedLexicon', 'SVP_1', 'SECFIgnoreWidth',
    'tagSPPROPERTYINFO', 'ISpeechRecoContext', 'ISpeechAudioStatus',
    'SPPS_Interjection', 'DISPID_SPPValue', 'SPEI_WORD_BOUNDARY',
    'SPPS_Noun', 'DISPID_SLWsItem', 'SVP_16', 'ISpeechMMSysAudio',
    'DISPID_SPIAudioSizeBytes', 'SVP_3', 'SPEI_TTS_BOOKMARK',
    'DISPID_SWFESamplesPerSec', 'SVP_4', 'SGRSTTEpsilon',
    'SRATopLevel', 'SECFNoSpecialChars',
    'ISpPhoneticAlphabetSelection', 'ISpeechAudioBufferInfo',
    'DISPID_SVSyncronousSpeakTimeout', 'SAFT44kHz8BitStereo',
    'DISPID_SRAudioInput', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SRDisplayUI', 'SPGRAMMARSTATE', 'DISPID_SAEventHandle',
    'SPCT_SUB_COMMAND', 'SSFMCreate', 'DISPID_SpeechPhraseAlternates',
    'SVEStartInputStream', 'DISPID_SOTId', 'DISPID_SVEStreamEnd',
    'SVP_12', 'eLEXTYPE_RESERVED7', 'SpeechWordPronounceable',
    'SPPHRASEPROPERTY', 'SPINTERFERENCE_NOISE', 'DISPID_SPIEngineId',
    'SREAdaptation', 'SPSFunction', 'DISPID_SRCreateRecoContext',
    'SPEI_SR_PRIVATE', 'DISPID_SPAsItem', 'eLEXTYPE_PRIVATE4',
    'SPEI_PHONEME', 'SP_VISEME_3', 'SSSPTRelativeToStart', 'SPSLMA',
    'SPPS_RESERVED1', 'SP_VISEME_20', 'SpeechAudioState',
    'SGRSTTWildcard', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SVPause', 'ISpeechRecoResult2', 'SGSExclusive',
    'DISPID_SPIAudioSizeTime', 'SPPHRASEELEMENT',
    'DISPID_SOTs_NewEnum', 'SPRST_INACTIVE',
    'DISPID_SPRNumberOfElements', 'DISPID_SpeechMMSysAudio',
    ...
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SRGRules',
    'DISPID_SVGetVoices', 'SPEI_UNDEFINED', 'SAFTNonStandardFormat',
    'SPRECOCONTEXTSTATUS', 'STSF_FlagCreate',
    'ISpeechRecoResultDispatch', 'SpeechRecoContextState',
    'SAFT24kHz8BitMono', 'DISPID_SOTCSetId', 'SPGS_DISABLED',
    'DISPID_SMSALineId', 'DISPID_SGRSTPropertyId',
    'ISpGrammarBuilder', 'eLEXTYPE_PRIVATE8', 'DISPID_SVEAudioLevel',
    'SPLO_DYNAMIC', 'eLEXTYPE_PRIVATE7', 'DISPID_SGRSTsCount',
    'DISPID_SRIsShared', 'SVP_2', 'ISpPhoneConverter',
    'SPDATAKEYLOCATION', 'SVESentenceBoundary', 'SFTInput',
    'DISPID_SPIAudioStreamPosition', 'SpeechEngineProperties',
    'SPSSuppressWord', 'SPWORDTYPE', 'SpeechAudioFormatType',
    'SpeechRuleAttributes', 'DISPID_SPRuleFirstElement', 'IStream',
    'DISPID_SPIGrammarId', 'SAFTCCITT_uLaw_22kHzMono', 'SP_VISEME_18',
    'SPSERIALIZEDRESULT', 'SpeechCategoryPhoneConverters',
    'ISpRecoCategory', 'SpeechUserTraining', 'SPDKL_CurrentConfig',
    'SPRS_ACTIVE', 'SpeechRecognizerState', 'SPRECORESULTTIMES',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SDTDisplayText',
    'DISPID_SLRemovePronunciation', 'DISPIDSPTSI_ActiveLength',
    'SPVPRI_OVER', 'SVSFPurgeBeforeSpeak', 'SPBO_TIME_UNITS',
    'SAFT22kHz8BitStereo', 'ISpeechRecoResult',
    'SpTextSelectionInformation', 'SRERequestUI',
    'DISPID_SOTCreateInstance', 'SSSPTRelativeToEnd', 'SPWORD',
    'SPSHT_OTHER', 'SLOStatic', 'SWPKnownWordPronounceable', 'SVP_5',
    'SPAS_CLOSED', 'SPSERIALIZEDPHRASE', 'DISPID_SRCPause',
    'ISpeechFileStream', 'DISPID_SVSInputSentencePosition',
    'DISPID_SRCBookmark', 'DISPID_SRRGetXMLResult',
    'DISPID_SLGetPronunciations', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SLPsItem', 'eLEXTYPE_PRIVATE17', 'SpeechTokenKeyUI',
    'SpeechRecoEvents', 'eLEXTYPE_PRIVATE15', 'DISPID_SBSSeek',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SRGetRecognizers', 'SpNullPhoneConverter',
    'DISPID_SABufferNotifySize', 'DISPID_SVEViseme',
    'SAFTGSM610_22kHzMono', 'DISPID_SOTCDefault', 'SPVPRI_ALERT',
    'DISPID_SPIStartTime', 'DISPID_SVSPhonemeId',
    'DISPID_SASNonBlockingIO', 'DISPID_SpeechLexiconProns',
    'DISPID_SGRSTText', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SpeechPhraseBuilder', 'ISpNotifySink', 'DISPID_SPCLangId',
    'DISPID_SGRSAddRuleTransition', 'SPEI_VOICE_CHANGE',
    'SpeechVoiceCategoryTTSRate', 'SpStreamFormatConverter',
    'DISPID_SASFreeBufferSpace', 'SPWORDPRONOUNCEABLE',
    ...
    'DISPID_SPEsItem', 'SPRS_ACTIVE_USER_DELIMITED', 'SPWF_INPUT',
    'SPEI_INTERFERENCE', 'SP_VISEME_13', 'DISPID_SRGId',
    'ISpeechCustomStream', 'ISpMMSysAudio', 'SPWF_SRENGINE',
    'DISPID_SDKGetlongValue', 'DISPID_SABufferInfo', 'SASRun',
    'DISPID_SPAs_NewEnum', 'eLEXTYPE_RESERVED6', 'SPEI_HYPOTHESIS',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SVSRunningState',
    'DISPID_SFSClose', 'SPINTERFERENCE_TOOLOUD', 'DISPID_SOTCategory',
    'eWORDTYPE_ADDED', 'ISpAudio', 'DISPID_SRCRetainedAudioFormat',
    'SRESoundStart', 'DISPID_SVGetAudioInputs',
    ...
    'SVPNormal', 'SPEI_MIN_SR', 'SP_VISEME_12',
    'DISPID_SPPNumberOfElements', 'SPWORDPRONUNCIATION',
    'eLEXTYPE_PRIVATE19', 'SPEI_START_SR_STREAM', 'SRARoot',
    'eLEXTYPE_RESERVED10', 'ISpRecognizer2', 'SPSMF_SAPI_PROPERTIES',
    'SDTPronunciation', 'SpeechPropertyNormalConfidenceThreshold',
    'eLEXTYPE_PRIVATE16',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechTextSelectionInformation', 'SPCATEGORYTYPE',
    'eLEXTYPE_PRIVATE12', 'SpMMAudioIn', 'DISPID_SGRsDynamic',
    'SPAR_Medium', 'SECFEmulateResult', 'SPRULE',
    'DISPID_SWFEExtraData', 'SP_VISEME_21',
    'DISPID_SRCEFalseRecognition', 'DISPID_SPELexicalForm',
    'DISPID_SpeechBaseStream', 'DISPID_SPRsCount', 'SPSHORTCUTPAIR',
    'SpeechGrammarTagDictation', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SVGetAudioOutputs', 'DISPID_SPRuleConfidence',
    'SPPS_RESERVED2', 'DISPID_SBSRead', 'DISPID_SVSpeakStream',
    'ISpeechMemoryStream', 'SP_VISEME_17', 'SPDKL_DefaultLocation',
    ...
    'DISPID_SRCRequestedUIType', 'DISPID_SpeechXMLRecoResult',
    'SpeechLoadOption', 'SpeechTokenShellFolder',
    'SpeechGrammarRuleStateTransitionType', 'SVSFIsXML',
    'DISPID_SRSetPropertyString', 'SGRSTTRule', 'SPPHRASERULE',
    'DISPID_SPEs_NewEnum', 'SP_VISEME_10', 'SVP_6', 'SPEI_MAX_TTS',
    'eLEXTYPE_PRIVATE9', 'SpPhoneConverter', 'SAFTGSM610_11kHzMono',
    ...
    'SpeechGrammarTagWildcard', 'SPEI_RESERVED3', 'SREPrivate',
    'eLEXTYPE_PRIVATE2', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SAFT8kHz8BitStereo', 'SDTLexicalForm', 'ISpeechPhraseRules',
    'ISpeechLexiconWords', 'ISpShortcut', 'SpeechMicTraining',
    'IEnumString', 'DISPID_SOTRemoveStorageFileName',
    'Speech_Max_Pron_Length', 'SPPHRASE', 'SPTEXTSELECTIONINFO',
    'DISPID_SPRDisplayAttributes', 'SITooQuiet',
    'SpeechRetainedAudioOptions', 'SVEViseme',
    'DISPID_SRCESoundStart', 'SREStreamStart',
    'SpeechStreamSeekPositionType', 'SPEI_MIN_TTS', 'SREStreamEnd',
    'SPEI_END_INPUT_STREAM', 'ISpRecoGrammar', 'SAFTDefault',
    'DISPID_SADefaultFormat', 'eLEXTYPE_PRIVATE6', 'SVP_8',
    'SPRST_ACTIVE', 'SVSFParseAutodetect', 'DISPID_SRCERecognition',
    'SVF_Emphasis', 'DISPID_SRRTStreamTime', 'ISpeechObjectTokens',
    'SPSInterjection', 'ISpeechPhraseReplacement', 'tagSTATSTG',
    'DISPID_SRGState', 'SpSharedRecoContext',
    'SPRST_INACTIVE_WITH_PURGE', 'SPAR_High', 'SPCT_SUB_DICTATION',
    'DISPID_SDKEnumValues', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SPPBRestorePhraseFromMemory', 'SRADefaultToActive',
    'SPEVENTSOURCEINFO', 'SAFTCCITT_ALaw_11kHzMono',
    'SPFM_OPEN_READONLY', 'SAFT32kHz16BitStereo',
    'DISPID_SVEVoiceChange', 'SVP_18', 'SRAExport',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SPCPhoneToId', 'SPEI_MAX_SR',
    'SRSEIsSpeaking', 'DISPID_SGRsItem', 'DISPID_SCSBaseStream',
    ...
    'DISPID_SVSpeak', 'SpeechPropertyResponseSpeed',
    'SPEI_REQUEST_UI', 'ISpeechObjectTokenCategory', 'ISpRecognizer',
    'DISPID_SRGCommit', 'SpeechPartOfSpeech', 'DISPID_SVRate',
    'DISPID_SVResume', 'SAFT48kHz8BitStereo',
    'DISPID_SVIsUISupported', 'SP_VISEME_0', 'DISPID_SLPLangId',
    'DISPID_SPPConfidence', 'DISPID_SRRTimes',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SpeechLexiconWord',
    'DISPID_SPRFirstElement', 'DISPID_SRSClsidEngine', 'SINoise',
    'SpeechVisemeFeature', 'SRSActiveAlways', 'SDTRule',
    'SGSDisabled', 'SPBOOKMARKOPTIONS',
    'DISPID_SpeechPhraseReplacements', 'SSTTTextBuffer',
    ...
    'IEnumSpObjectTokens', 'SRAONone', 'DISPID_SpeechAudioStatus',
    'SPCS_ENABLED', 'DISPID_SpeechGrammarRules',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SGRSTNextState',
    'DISPID_SRRAlternates', 'DISPID_SpeechLexiconPronunciation',
    'SPEI_START_INPUT_STREAM', 'DISPID_SRGSetTextSelection',
    'SREPropertyNumChange', 'SPSTREAMFORMATTYPE',
    ...
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SDKEnumKeys',
    'SPAS_PAUSE', 'SPEI_SR_BOOKMARK', 'DISPIDSPTSI',
    ...
    'SAFT22kHz16BitStereo', 'SAFT44kHz8BitMono', 'SPSModifier',
    'DISPID_SABIMinNotification', 'SPEI_RESERVED6', 'ISpeechVoice',
    'ISpeechRecoGrammar', 'SpeechAudioFormatGUIDWave',
    'SpeechStreamFileMode', 'DISPID_SRCEStartStream', 'DISPIDSPRG',
    'DISPID_SRCERequestUI', 'SPVOICESTATUS', 'SVPAlert',
    'DISPID_SRCEventInterests', 'SAFTADPCM_11kHzStereo',
    'SPEI_RECO_OTHER_CONTEXT', 'Speech_Max_Word_Length',
    'ISpRecoGrammar2', 'DISPID_SpeechLexiconWords',
    'DISPID_SRGRecoContext', 'DISPID_SRRRecoContext',
    '_RemotableHandle', 'SAFT22kHz8BitMono',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRCRecognizer',
    'SVP_7', 'SPXMLRESULTOPTIONS', 'DISPID_SMSSetData', 'SPBO_NONE',
    'SAFTCCITT_uLaw_8kHzStereo', 'SWTAdded',
    'SAFTTrueSpeech_8kHz1BitMono', 'SBOPause', 'DISPID_SPCIdToPhone',
    'SVEPhoneme', 'SPINTERFERENCE_NONE', 'DISPID_SRGDictationLoad',
    'SAFT8kHz16BitStereo', 'DISPID_SRRSaveToMemory', 'SP_VISEME_4',
    'DISPID_SRRSetTextFeedback', 'STSF_LocalAppData',
    'DISPID_SPIProperties', 'SAFTADPCM_22kHzStereo',
    'SAFT16kHz8BitMono', 'SPPS_RESERVED4', 'SPAO_RETAIN_AUDIO',
    ...
    'ISpeechGrammarRules', 'SRERecognition',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SGRSTPropertyName',
    'SVSFParseMask', 'DISPID_SVSLastBookmark', 'SpInProcRecoContext',
    'DISPID_SRGetFormat', 'SpVoice', 'DISPID_SRCESoundEnd',
    'ISpeechPhraseElement', 'SPEI_SR_RETAINEDAUDIO', 'SpCustomStream',
    'SWTDeleted', 'DISPID_SVVoice', 'SpeechAudioFormatGUIDText',
    'SPEI_RESERVED5', 'DISPID_SLGetWords', 'SPPS_Function',
    'DISPID_SVSkip', 'STCInprocServer', 'DISPID_SVEBookmark',
    'DISPID_SAFGetWaveFormatEx', 'ISpeechPhraseInfo',
    'SVSFNLPSpeakPunc', 'DISPID_SGRSTRule',
    'DISPID_SpeechRecoResultTimes', 'SRESoundEnd', 'SVEAudioLevel',
    'SpLexicon', 'SPGRAMMARWORDTYPE', 'SVEPrivate',
    'SAFTADPCM_11kHzMono', 'DISPIDSPTSI_ActiveOffset', 'SPAO_NONE',
    'SpeechPropertyResourceUsage', 'eWORDTYPE_DELETED', 'SVP_14',
    'SpShortcut', 'SPEVENT', 'DISPID_SRCState', 'DISPID_SGRName',
    'SSTTWildcard', 'DISPID_SGRSTsItem', 'ISpeechAudio',
    'SP_VISEME_8', 'SSTTDictation', 'SPPARTOFSPEECH',
    'DISPID_SpeechWaveFormatEx', 'SVP_19', 'SpeechDiscardType',
    'DISPID_SVSpeakCompleteEvent',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPVPRI_NORMAL',
    'ISpeechDataKey', 'SPPS_SuppressWord', 'SPEI_VISEME',
    'SAFT11kHz16BitMono', 'SPSEMANTICFORMAT', 'SpeechGrammarState',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SpeechAudioFormat',
    'SPSHT_NotOverriden', 'SPPS_Verb', 'SRTAutopause',
    'SPPS_Noncontent', 'DISPID_SGRsCount', 'SpInprocRecognizer',
    'SPPS_LMA', 'STSF_AppData', 'SASStop', 'SGRSTTDictation',
    'SpeechLexiconType', 'SRSInactive',
    'DISPID_SRCERecognitionForOtherContext', 'SAFT32kHz16BitMono',
    'SREAudioLevel', 'DISPIDSPTSI_SelectionOffset', 'DISPID_SAVolume',
    'DISPID_SVEPhoneme', 'DISPID_SVSInputWordLength', 'SVSFlagsAsync',
    'DISPID_SGRsAdd', 'DISPID_SpeechPhraseRules', 'SVP_17',
    'typelib_path', 'DISPID_SPPFirstElement', 'SPCS_DISABLED',
    'ISpeechPhraseInfoBuilder', 'DISPID_SPEAudioSizeTime',
    'SpeechAudioVolume', 'DISPID_SVSLastBookmarkId',
    'DISPID_SVAudioOutputStream', 'DISPID_SPAPhraseInfo', 'SITooFast',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SRCSetAdaptationData',
    'DISPID_SRCCmdMaxAlternates', 'SAFTCCITT_uLaw_44kHzStereo'
]

_check_version('1.4.0', 1700036922.512897)
